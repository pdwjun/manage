...
namespace vova07\roles\models;

use vova07\rbac\models\RoleManage;
use vova07\roles\helpers\Security;
use vova07\roles\Module;
use vova07\roles\traits\ModuleTrait;
 ...
 */
class Role extends ActiveRecord implements IdentityInterface
{
    use ModuleTrait;
     ...
     */
    public static function findByRolename($name, $scope = null)
    {
...
//            'updated_at' => Module::t('users', 'ATTR_UPDATED'),
    ...
    public static function getNameByID($id){
        $item = RoleManage::find()->where(['id'=>$id])->findone();
        return $item['name'];
    }
}
