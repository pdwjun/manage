...
class Module extends \yii\base\Module
{
     ...
     * @inheritdoc
     */
    public $controllerNamespace = 'vova07\roles\controllers\frontend';
     ...
     */
    public $avatarsTempPath = '@statics/temp/roles/avatars';

    /**
     * @var Path where will be saved user's avatar
     */
    public $avatarPath = '@statics/web/roles/avatars';

    /**
     * @var Avatars path URL
     */
    public $avatarUrl = '/statics/roles/avatars';
    ...
    public function init()
    {
        ...
        if ($this->isBackend === true) {
            $this->setViewPath('@vova07/roles/views/backend');
        } else {
            $this->setViewPath('@vova07/roles/views/frontend');
        }
    }
    ...
    public function getMail()
    {
        if ($this->_mail === null) {
            ...
            $this->_mail->htmlLayout = '@vova07/roles/mails/layouts/html';
            $this->_mail->textLayout = '@vova07/roles/mails/layouts/text';
            $this->_mail->viewPath = '@vova07/roles/mails/views';
